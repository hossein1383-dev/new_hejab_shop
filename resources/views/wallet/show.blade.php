...
<div class="wallet-balance-card">
    ...
    <span class="wallet-balance-card__amount">{{ number_format($wallet->balance) }} تومان</span>
</div>

<div class="admin-form" style="margin: var(--space-4) 0; border: 1px solid var(--border); border-radius: var(--radius-card); padding: var(--space-4);">
